...
async def _(event):
    await event.edit(
        "[ᯓ M - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/R2RR7) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر النشــر التلقــائي 🌐](t.me/R2RR7  ) .
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر تجميــع النقــاط 🛂](t.me/R2RR7) .
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/R2RR7) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ M 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/R2RR7) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر مكـافح التكــرار 🛡](t.me/R2RR7) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر المنــع 🚫](t.me/R2RR7) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر تحميـل الكتب 📕](t.me/R2RR7) .
**- الامـر :**
**⪼** `.كتاب`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر بحـث تيليـجـرام 🛰](t.me/R2RR7) .
**- الامـر :**
**⪼** `.تلي` **+ كلمـة**
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر التسليـه 🏂](t.me/R2RR7) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر التحشيش 🎃](t.me/R2RR7) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر الالـعــاب 🎮🎳](t.me/R2RR7) .
**- الامـر :**
**⪼** `.بلاي`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر حمـايــة الخــاص 🛡](t.me/R2RR7) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ M - فــارات حمـايــة الخــاص 🛡](t.me/R2RR7) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر الستـوريـات 🎆🏖](t.me/R2RR7) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/R2RR7) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامـر السبـام والتكـرار](t.me/ZTho) .
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر الاشتــراك الاجبــاري 🛗](t.me/R2RR7) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ M - اوامــر الصيـد & الـتثبيت ❇️](t.me/R2RR7) .
